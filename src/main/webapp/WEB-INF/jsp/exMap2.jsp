...
selectSingleClick.on('select', function(e) {
  if(e.target.getFeatures().a[0] != undefined){
    _style = e.target.getFeatures().a[0];
    e.target.getFeatures().a[0].setStyle(null);
  }
